    ...
    return (
        <div>
            ...
            <button 
                ...
                disabled={isGenerating || picks.length === 0}
            ...
            {/* THE HIDDEN GRAPHIC (What the camera actually takes a picture of) */}
                ...
                >
                    ...
                    <div className="flex justify-between items-end mb-6">
                        ...
                        <div className="text-right">
                            ...
                            <p className="text-xs font-bold text-teal-400 uppercase">{eventName || 'Upcoming Event'}</p>
                        </div>
                    </div>
                        ...
                        {picks.map((pick, index) => (
                            <div key={index} className="bg-gray-900 border border-gray-800 p-3 flex items-center justify-between rounded">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div className="text-sm font-black text-white uppercase">{pick.selected_fighter || pick.fighterName}</div>
                                </div>
                                <div className="text-teal-400 text-lg">⚔️</div>
                            </div>
                        ))}
                    </div>

                    {/* Footer / Barcode */}
                    <div className="pt-4 border-t border-gray-800 flex justify-between items-center opacity-70">
